new Vue({
    ...
    'data': {
        ...
        'pots': [ {"teams": [{'name': "RUS", 'fed': 'UEFA', 'chosen': true}, 
                  ...
                  {"teams": [{'name': "ESP", 'fed': 'UEFA', 'chosen': false}, 
